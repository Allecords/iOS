...
# Configuration
XCODE_TEMPLATE_DIR=$HOME'/Library/Developer/Xcode/Templates/File Templates/Allecords'
...
echo "==> ... success!"
echo "==> Allecords have been set up. In Xcode, select 'New File...' to use Allecords templates."
